...
3. In `src/run_inpainting.py`, in the **main** block, make sure the proper image is being read, and type in your hairstyles in the prompts array.
...
| Leon Eberhardt | Curated datasets of images along with caption embeddings to be fed to the model for finetuning, created prompt validation scripts.                                                                                                                                                                                                                                      |
